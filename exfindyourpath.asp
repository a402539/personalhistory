...
<TITLE>Path Help For Brinkster Customers</TITLE>
...
'--------------------------------------------------- some parcing code that will display the root path.

sRootDirectory = Request.ServerVariables("APPL_PHYSICAL_PATH")

sRootDirectory = Replace(sRootDirectory, "webroot\", "")
