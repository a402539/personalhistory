...
<TITLE>Проверка работы с базой данных</TITLE>
...
<FONT CLASS='Font14BoldBlue'>Работа с базой данных</FONT>
...
<FONT CLASS=Font12BoldBlue>Создание таблицы<BR></FONT><FONT CLASS=Font10>
