...
// [Initial MovieClip Action of sprite 199]
#initclip 95
class com.fbpublisher.basicskin.viewclasses.buttons.RightArrowButton extends com.fbpublisher.basicskin.viewclasses.VisualComponent
{
    var _clip, button, _icon, _button, dispatchEvent;
    function RightArrowButton(clip)
    {
        super(clip);
        mx.events.EventDispatcher.initialize(this);
        button = _clip.createEmptyMovieClip("buttonData", level++);
        _icon = new com.fbpublisher.basicskin.viewclasses.BitmapIcon(button, "arrowRight");
        this._createButton();
